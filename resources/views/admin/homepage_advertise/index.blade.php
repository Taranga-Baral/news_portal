        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>HomePage Advertise Index Page</h4>

                    <a href="{{ route('homepage_advertise.create') }}" class="btn btn-primary">Add</a>
                            ...
                            <tbody>
                                ...
                                @foreach ($advertises as $index => $advertise)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('homepage_advertise.destroy', $advertise->id) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('homepage_advertise.edit', $advertise->id) }}"
