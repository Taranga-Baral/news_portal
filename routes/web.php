...
use App\Http\Controllers\Admin\HomePageAdvertiseController as AdminHomePageAdvertiseController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/admin/homepage_advertise', AdminHomePageAdvertiseController::class)->names('homepage_advertise');
});
